...
import { ITypes, SET_PROFILE_PAGE, GET_PROFILE_POST, GET_FAVORITES_POST, SET_EDITING_POST } from './constants';

function profileReducer(state: ProfileStore = store, action: ITypes) {
    switch (action.type) {
