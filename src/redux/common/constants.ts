...
import { Post, Sorting, PostListData, Filter } from '../../interfaces';
...
export type IRegistration = { type: typeof REGISTRATION, payload: { email: string, password: string, nickName: string } };
