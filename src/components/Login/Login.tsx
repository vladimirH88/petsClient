...
const Login: React.FC<Props> = ({ user, login }) => {
    ...
    const emailInputHundler = useCallback(
    ...
    const passwordInputHundler = useCallback(
        (e: React.ChangeEvent<HTMLInputElement>): void => {
                ...
                <form name="loginForm">
                    ...
                    <fieldset className="form-group">
                        <input
                            ...
                            onChange={passwordInputHundler}
                        />
                    </fieldset>
                    <fieldset className="form-group">
                        <button
                            type="button"
                            className="btn btn-primary btn-lg form-control mt-2"
                            onClick={submitClick}
                        >
                            {t('login.logIn')}
                        </button>
                    ...
                    <p className="text-center">
                        <Link to={ROUTES.REGISTRATION}>{t('login.registration')}</Link>
                    </p>
                </form>
            </div>
        </div>
